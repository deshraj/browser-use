...
async def main(session_name, session_id, max_steps, summarize_every_n_steps):
	...
	agent = Agent(
		...
		enable_memory_summarization=True if summarize_every_n_steps > 0 else False,
...
if __name__ == '__main__':
	...
	parser.add_argument('--summarize_every_n_steps', type=int, default=-1)
	args = parser.parse_args()
	session_name = args.session_name
	session_id = args.session_id
	max_steps = args.max_steps
	summarize_every_n_steps = args.summarize_every_n_steps
	print('--- Arguments Start ---')
	print(f'Session Name: {session_name}')
	print(f'Session ID: {session_id}')
	print(f'Max Steps: {max_steps}')
	print(f'Summarize Every N Steps: {summarize_every_n_steps}')
	print('--- Arguments End ---')
	asyncio.run(main(session_name, session_id, max_steps, summarize_every_n_steps))
